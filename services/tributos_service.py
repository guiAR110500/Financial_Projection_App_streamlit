...
from models.tributos import TributosPremises, RegimeTributario, ImpostoCalculado
...
class TributosCalculator(BaseCalculator):
    ...
    def _perform_calculation(self, receitas_mensais: List[float], 
                           despesas_mensais: Optional[List[float]] = None, **kwargs) -> Dict[str, Any]:
